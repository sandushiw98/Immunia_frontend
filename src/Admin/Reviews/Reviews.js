...
import { DatePicker, Space, Button,Avatar, Badge, } from "antd";
  ...
  return (
    <>
      ...
      <Row style={{ paddingTop: "100px" }}>
        <Col span={20}>
          <h1 style={{ paddingLeft: "20px" }}>Reviews</h1>
        </Col>
        <Col span={4} style={{ padding: "25px" }}>
      ...
      <Row style={{ padding: "50px" }} >
        ...
        <Col span={4}>
          <h2>Sandali Jasinghe</h2>
          <br />
          <p>26/07/2-23 3.15 P.M</p>
        </Col>
        <Col span={16}>
        {/* <Row> */}
          <Col><h2>Message</h2></Col>
          {/* <Col><Badge dot>
      ...
      <Divider />
      <Row style={{ padding: "50px" }} gutter={5}>
        <Col span={3}>
          <Image
          className="parentimage"
            width={150}
