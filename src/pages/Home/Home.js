...
const Home = () => {
    ...
    return (
        <>
            ...
            {/* slider images */}
            <Row className='rsis-image' style={{ overflowX: 'hidden' }}>
                <Navbar />
                <Col xl={24} lg={24} sm={24} xs={24} id='home'>
            ...
            <Row>
                <Col xl={12} lg={12} sm={24} xs={24} style={{ padding: '50px', paddingLeft: '5%' }} className='why-vaccine'>
                ...
                <Col xl={12} lg={12} sm={24} xs={24} style={{ padding: '50px', paddingLeft: '5%' }} className='why-vaccine'>
                    ...
                    <Row style={{ paddingLeft: '8%', paddingTop: '50px' }} className='include-btn'>
                        <Col span={8}>
                            <Link to='/newborn'>
            ...
            <Row style={{ backgroundColor: '#f6f3ee' }} id='about'>
                <Col xl={12} lg={12} sm={24} xs={24} style={{ padding: '20px' }} >
                ...
                <Col xl={12} lg={12} sm={0} xs={0} style={{ padding: '100px' }}>
                    <img src={image10} alt="image1" className='about-image' style={{ width: '100%', height: '100%' }} />
                </Col>
            </Row>
            ...
            <Row>
                ...
                <Row style={{ width: '100%' }}>
                    <Col xl={12} lg={12} sm={24} xs={24} style={{ width: '100%', paddingTop: '55px' }}>
                        <Row style={{ paddingLeft: '18%' }} >
                        ...
                        <Row className='donate-image' style={{ padding: '10px 150px 10px 180px' }}>
                            <img src={image6} alt="image6" style={{ width: '100%', height: '90%' }} />
                        </Row>
                    </Col>
                    <Col xl={12} lg={12} sm={24} xs={24} style={{ width: '100%', padding: '90px 100px' }} className='donate-form'>
                        <Card sx={{ minWidth: 275 }} style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '30px 60px', backgroundColor: '#f6f3ee', width: '60%', marginTop: '20px' }} className='donate-form'>
                            <Row>
                                <Col span={24}>
                                    <span style={{ fontSize: '80px', color: 'brown' }}>100 Rs</span>
                                </Col>
                            </Row>
                            <Row>
                                <Col span={24}>
                                    <span style={{ fontSize: '30px', color: 'black', marginTop: '10px', marginBottom: '20px' }}>Donation Amount</span>
                                </Col>
                            </Row>
                            <Row>
                                <Col span={6}><Button className='donate-btn'>Rs 25</Button></Col>
                                <Col span={6}><Button className='donate-btn'>Rs 50</Button></Col>
                                <Col span={6}><Button className='donate-btn'>Rs 100</Button></Col>
                                <Col span={6}><Button className='donate-btn'>Rs 200</Button></Col>
            ...
            <Row style={{ backgroundColor: '#f6f3ee' }} id='contact'>
                ...
                <Row className="horizontal-line-donate" ></Row>
                <Row style={{ width: '100%' }}>
                    <Col xl={12} lg={12} sm={12} xs={12} style={{ width: '100%', padding: '50px' }} >
                    ...
                    <Col xl={12} lg={12} sm={12} xs={12} style={{ width: '100%', paddingLeft: '200px', paddingTop: '1%' }} className='cntct-us'>
                        <Row>
