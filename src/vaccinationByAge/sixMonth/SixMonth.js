...
import cover from '../../assets/images/6-months.png';
                    ...
                    <Row style={{ padding: '30px 100px 60px 100px', background: '#fff', minHeight: '100vh' }}>
                        <Col style={{ minWidth: '100%' }}>
                            <Row style={{ paddingBottom: '30px' }}>
                                <span style={{ fontSize: '45px' }}>Vaccines at 5 to 6 Months</span>
                            </Row>
                            <Row>
                            ...
                            <Row>
                                <p style={{ fontSize: '18px' }}>At 6 months old, your baby is ready for another round of vaccines, including their first flu shot. As your little one continues to grow and develop, help protect them from these potentially serious diseases.</p>
                            </Row>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {expanded && <div className="additional-content">
                                            <Row>
                                                <span style={{ fontSize: '20px' }}>3rd dose of 5</span>
                                            </Row>
                                            <Row style={{ paddingTop: '10px' }}>
                            ...
                            <Row style={{ paddingTop: '10px' }}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {expanded && <div className="additional-content">
                                            <Row>
                                                <span style={{ fontSize: '20px' }}>3rd dose of 4</span>
                                            </Row>
                                            <Row style={{ paddingTop: '10px' }}>
                            ...
                            <Row style={{ paddingTop: '10px' }}>
                                ...
                                >
                                    <Panel
                                        header={
                                            <div onClick={handleExpand}>
                                                <span style={{fontSize: '22px'}}>Influenza (Flu)</span>
                                            </div>
                                        }
                                    >
                                        {/* Content of the expandable component */}
                            ...
                            <Row style={{ paddingTop: '10px' }}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {expanded && <div className="additional-content">
                                            <Row>
                                                <span style={{ fontSize: '20px' }}>3rd dose of 3</span>
                                            </Row>
                                            <Row style={{ paddingTop: '10px' }}>
