...
import cover from '../../assets/images/4-months.png';
import './FourMonth.css';
                    ...
                    <Row style={{ padding: '30px 100px 60px 100px', background: '#fff', minHeight: '100vh' }}>
                        <Col style={{ minWidth: '100%' }}>
                            <Row style={{ paddingBottom: '30px' }}>
                                <span style={{ fontSize: '45px' }}>Vaccines at 4 Months</span>
                            </Row>
                            <Row>
                            ...
                            <Row>
                                <p style={{ fontSize: '18px' }}>Now that your baby is 4 months old, they’ve likely started getting their childhood vaccines and they are ready for another check-up. Routine doctor visits help ensure that your baby receives their second doses of important vaccines at the right time.<br /><br />At 4 months, your baby should receive vaccines to help protect against the following diseases:</p>
                            </Row>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {expanded && <div className="additional-content">
                                            <Row>
                                                <span style={{ fontSize: '20px' }}>2nd dose of 5</span>
                                            </Row>
                                            <Row style={{ paddingTop: '10px' }}>
                            ...
                            <Row style={{ paddingTop: '10px' }}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {expanded && <div className="additional-content">
                                            <Row>
                                                <span style={{ fontSize: '20px' }}>2nd dose of 3 or 4</span>
                                            </Row>
                                            <Row style={{ paddingTop: '10px' }}>
                            ...
                            <Row style={{ paddingTop: '10px' }}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {expanded && <div className="additional-content">
                                            <Row>
                                                <span style={{ fontSize: '20px' }}>2nd dose of 4</span>
                                            </Row>
                                            <Row style={{ paddingTop: '10px' }}>
                            ...
                            <Row style={{ paddingTop: '10px' }}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {expanded && <div className="additional-content">
                                            <Row>
                                                <span style={{ fontSize: '20px' }}>2nd dose of 2 or 3</span>
                                            </Row>
                                            <Row style={{ paddingTop: '10px' }}>
